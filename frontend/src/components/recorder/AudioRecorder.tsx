  ...
  return (
    ...
    >
      <VStack spacing={4} align="stretch">
        ...
        <Box h="60px" bg="gray.50" borderRadius="md" p={2}>
          {recordingData && !isRecording ? (
            <WaveformDisplay audioUrl={recordingData.url} />
          ) : (
            <Flex h="100%" align="center" justify="center">
              <Text color="gray.400" fontSize="sm">
                {isRecording ? "Recording in progress..." : "Audio visualization will appear here"}
              </Text>
            </Flex>
          )}
        </Box>
        ...
        <HStack spacing={4} justify="center">
          ...
          {!isRecording && !recordingData && (
            <Tooltip label="Start recording the session">
              <Button
          ...
          {isRecording && (
            <Tooltip label="Stop and save the recording">
              <Button
                leftIcon={<FaStop />}
                colorScheme="gray"
          ...
          {recordingData && !isRecording && (
            <>
              <Tooltip label="Generate transcript from recording">
                <Button
                  leftIcon={<FaSave />}
                  colorScheme="blue"
              ...
              <Tooltip label="Clear the current recording">
                <Button
                  leftIcon={<FaTrash />}
                  colorScheme="red"
                  variant="outline"
